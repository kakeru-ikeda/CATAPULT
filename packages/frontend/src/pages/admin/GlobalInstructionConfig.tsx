...
export const GlobalInstructionConfig = () => (
  <>
    <List resource="instructions/global">
      <Datagrid rowClick="edit">
        <TextField source="name" label="名前" />
        <BooleanField source="isActive" label="有効" />
        <EditButton resource="instructions/global" />
        <DeleteButton resource="instructions/global" />
      </Datagrid>
    </List>
    <Create resource="instructions/global">
...
export const GlobalInstructionEdit = () => (
  <Edit resource="instructions/global">
    <SimpleForm toolbar={<InstructionFormToolbar />}>
