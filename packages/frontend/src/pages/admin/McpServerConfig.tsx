  ...
  <>
    <List resource="mcp-servers/global">
      <Datagrid rowClick="show">
        ...
        <EditButton resource="mcp-servers/global" />
        <DeleteButton resource="mcp-servers/global" />
      </Datagrid>
    </List>
    <Create resource="mcp-servers/global">
...
export const McpServerGlobalEdit = () => (
  <Edit resource="mcp-servers/global">
    <SimpleForm toolbar={<McpServerFormToolbar />} validate={validateMcpServer}>
      <McpServerEditor />
    </SimpleForm>
  </Edit>
...
export const McpServerGlobalShow = () => (
